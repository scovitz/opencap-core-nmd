...
def downloadAndZipSession_cleanTrialsOnly(session_id,clean_trials_list,deleteFolderWhenZipped=True,isDocker=True,
    ...
    # only keep dynamic_ids that are clean trials 
    dynamic_ids = [t['id'] for t in session['trials'] if (t['name'] != 'calibration' and t['name'] !='neutral') and t['name'] in clean_trials_list]
